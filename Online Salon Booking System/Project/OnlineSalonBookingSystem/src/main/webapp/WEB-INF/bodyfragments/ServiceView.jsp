...
<div class="p-5  mt-4 mb-4 bg-image"
										...
										<sf:form method="post"
											...
											<div class="form-outline">
												...
												<s:bind path="serviceName">
													<sf:input path="${status.expression}" required="true" 
   ...
   <font color="red" style="font-size: 13px"><sf:errors
								path="${status.expression}" /></font>
								 <label class="form-label" for="form3Example4">This Service For</label>


						<sf:select class="form-control" path="${status.expression}">
					             	<option selected disabled>--------Select Gender Type-------</option>
									<sf:option value="Mans"/>
									<sf:option value="Womans" />
								</sf:select>
					</s:bind>
...
<!-- User Type Feild End -->
											...
											<div class="form-outline mb-3">
												...
												<s:bind path="address">
													<sf:textarea path="${status.expression}" cols="3" rows="3" required="true" 
